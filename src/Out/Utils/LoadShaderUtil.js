...
function processLoadShader(shaderProgArray, req, index) {
...
//加载着色器的方法
function loadShaderFile(shaderProgArray, url, index) {
    var req = new XMLHttpRequest(); //创建XMLHttpRequest对象
    req.onreadystatechange = function () { processLoadShader(shaderProgArray, req, index); }; //调用processLoadShader处理响应
